...
#define FFMPEG_CONFIGURATION "--disable-mmx --disable-mmx2 --disable-ssse3"
...
#define ENABLE_RTMP_PROTOCOL 1
#define CONFIG_PIPE_PROTOCOL 1
#define ENABLE_PIPE_PROTOCOL 1

#define CONFIG_CODE_PROTOCOL 1
#define ENABLE_CODE_PROTOCOL 1


#define ENABLE_MMS_PROTOCOL 1
#define ENABLE_MMSH_PROTOCOL 1
#define ENABLE_MMST_PROTOCOL 1
